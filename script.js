...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("h1", null, "Hello Honey"), /*#__PURE__*/
      React.createElement("h2", null, "Welcome, we want a help from you"), /*#__PURE__*/
      React.createElement("p", null, "This is a classic website, no traps or weird stuff!"), /*#__PURE__*/
      React.createElement("p", null, "We are getting a problem while trying to click the button"),
      React.createElement("p", null, "A small fellow is taking away the cursor, can you please warn that abbai"), /*#__PURE__*/
